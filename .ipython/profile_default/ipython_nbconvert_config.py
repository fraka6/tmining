...
# a config file.
# 
# - path2url - citation2latex - prevent_list_blocks - strip_files_prefix -
# posix_path - add_anchor - highlight2latex - escape_latex - comment_lines -
# strip_ansi - html2text - get_lines - ipython2python - ansi2latex -
# highlight2html - wrap_text - indent - markdown2latex - ansi2html -
# markdown2html - ascii_only - markdown2rst - filter_data_type - strip_dollars -
# add_prompts
...
# 
# c.ExtractOutputPreprocessor.extract_output_types = set(['application/pdf', 'image/jpeg', 'image/png', 'image/svg+xml'])
